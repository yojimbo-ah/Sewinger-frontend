...
import { updateProductMutation , queryClient} from "../../utils/http"
import { AuthContext } from "../../Contexts/AuthContext"

const categories = ["Sewing", "Crochet", "Male", "Female", "Clothing" ,"Cute" ] ;

export default function EditProductForm ({modalRef , itemData}) {
    ...
    const [formData , setFormData] = useState({
        ...
        quantity : itemData.availbleItems ,
    ...
    const {mutate , data , isPending } = useMutation({
        mutationFn : ({data}) => {
            return updateProductMutation({data : data , jwtToken : token , productId : itemData._id })
        } ,
        onSuccess : () => {
    ...
    return <>
        <form action={handleFormAction} className="w-full h-full flex flex-col ">
            ...
            handleChange={handleNameChange} onBlur={handleBlur} onFocus={handleFocus} focus={focus.name} tag='The title :'
                />
            ...
            handleChange={handleDescriptionChange} onBlur={handleBlur} onFocus={handleFocus} showError={!error.description.valid && !focus.description} tag='The description'
                />
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                {data && <p className="text-green-600 text-center text-xl">
                        product has been updated it would be pended until admin rectify it
                    </p>}
